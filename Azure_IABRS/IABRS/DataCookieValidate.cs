...
namespace IABRS
{
    ...
    //{
    //    private readonly DbContextOptions<testsForNADContext> _multiTenantOptions;

    //    public DataCookieValidate(DbContextOptions<testsForNADContext> multiTenantOptions)
    //    {
